...
module ChefRun
  class TargetResolver
    ...
    def target_to_valid_url(target)
      ...
      credentials = make_ssh_credentials(inline_user, inline_password)
      "#{prefix}#{credentials}#{host}"
    end

    private

    def make_ssh_credentials(inline_user, inline_password)
      ...
      if user.nil? && password.nil?
        ...
        #  - user:password
        #  - user:
        # Train (and ::URI) parsing handles these combinations correctly
